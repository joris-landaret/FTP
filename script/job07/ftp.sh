...
#installation de FTP avec proftpd
sudo apt install proftpd

# Installation de filezilla
sudo apt install filezilla

#	# Configuration de proftpd pour la sécurité TLS SSL
sudo echo '#
...
# création du certifica et de la clef
openssl req -new -x509 -days 365 -nodes -out /etc/proftpd/ssl/proftpd.cert.pem -keyout /etc/proftpd/ssl/proftpd.key.pem

# changer les droits du dossier ssl et de ses fichiers
sudo chmod -R 640 /etc/proftpd/ssl

# Configuration de tls.conf pour la sécurité TLS SSL
sudo echo "#
...
# Configuration de modules.conf pour la sécurité TLS SSL
echo "#
